  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Redtail Market" },
      {
        ...
        content: "Handcrafted reclaimed, distressed and primitive decor and gifts.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Abril+Fatface&family=Cabin:wght@400;500;600&family=Pinyon+Script&display=swap",
      },
